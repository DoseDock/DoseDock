...
# Backend Settings
BACKEND_URL = 'http://YOUR_SERVER_IP:4000/query'  # GraphQL endpoint
...
WIFI_TIMEOUT_SEC = 30     # Max seconds to wait for WiFi connection

# Hardware Pin Assignments (adjust for your wiring)
LED_PIN = 'LED'           # Onboard LED for status

# Per-silo vibration motor pins (one pancake motor per silo)
VIBRATION_MOTOR_PINS = [16, 17, 18]

# Per-silo beam break sensor pins (one sensor per silo)
